...
import static com.example.iumedia.fragment.CreateAccountFragment.EMAIL_REGEX;
...
public class LoginFragment extends Fragment {
    ...
    private Button loginBt, googleSignInBtn;
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    if (user.isEmailVerified()){
                                        Toast.makeText(getContext(), "Pls verify your email", Toast.LENGTH_SHORT).show();
                                    }
